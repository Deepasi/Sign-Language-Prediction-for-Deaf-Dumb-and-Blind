...
flag=False
suv=0
count = len(oss.listdir(r"C:\Users\Admin\Downloads\SignLang_Proj (1)\SignLang_Proj\AtoZ_3.1"))
c_dir = 'A'
white=np.ones((400,400),np.uint8)*255
cv2.imwrite(r"C:\Users\Admin\Downloads\SignLang_Proj (1)\SignLang_Proj\white.jpg",white)
...
while True:
    try:
        ...
        white = cv2.imread(r"C:\Users\Admin\Downloads\SignLang_Proj (1)\SignLang_Proj\white.jpg")
        ...
        if interrupt & 0xFF == ord('n'):
            ...
            if ord(c_dir)==ord('Z')+1:
                c_dir='A'
            flag = False
            count = len(oss.listdir(r'C:\Users\Admin\Downloads\SignLang_Proj (1)\SignLang_Proj\AtoZ_3.1' + (c_dir)))
        ...
        if flag==True:
            ...
            if suv==180:
                flag=False
            if step%3==0:
                cv2.imwrite(r"C:\Users\Admin\Downloads\SignLang_Proj (1)\SignLang_Proj\AtoZ_3.1" + (c_dir) + "/" + str(count) + ".jpg",
                            skeleton1)
